...
MultiLayerPerceptron::ForwardingIntermediateStorage MultiLayerPerceptron::make_forwading_storage() const
{
...
MultiLayerPerceptron::BackPropagationIntermediateStorage MultiLayerPerceptron::make_backpropagation_storage() const
{
...
void MultiLayerPerceptron::train(int label,
                                 const float x[],
                                 ForwardingIntermediateStorage* data,
                                 BackPropagationIntermediateStorage* error_data,
                                 float learning_rate,
